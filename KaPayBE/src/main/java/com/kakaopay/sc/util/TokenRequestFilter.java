...
public class TokenRequestFilter extends OncePerRequestFilter{
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        try {
        	if(!"/replyQna".equals(request.getRequestURI())||!"/assignQna".equals(request.getRequestURI())) { 
                ...
                if (token == null) {
                    ...
                    if (tokenInfo != null) {
                        String agtId = tokenInfo.getClaim("agtId").asString();
                        UserDetails loginUser = agentService.loadUserByUsername(agtId);
